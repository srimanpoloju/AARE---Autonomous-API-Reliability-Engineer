...
public class RcaReport {
    ...
    @JdbcTypeCode(SqlTypes.JSON)
    @Column(name = "affected_endpoints", columnDefinition = "jsonb")
    private List<String> affectedEndpoints;

    @Column(name = "severity_reason", columnDefinition = "TEXT")
    private String severityReason;

    @Column(name = "rollback_vs_patch_recommendation", columnDefinition = "TEXT")
    private String rollbackVsPatchRecommendation;
